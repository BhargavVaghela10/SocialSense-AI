...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/40 text-slate-800 transition-colors duration-300 relative overflow-x-hidden">

      {/* Decorative background blobs */}
      <div className="pointer-events-none absolute top-0 left-1/4 w-96 h-96 bg-indigo-300/20 rounded-full blur-3xl -z-10" />
      <div className="pointer-events-none absolute top-1/3 right-1/4 w-96 h-96 bg-purple-300/20 rounded-full blur-3xl -z-10" />

      {/* ─── Header ─── */}
      <header className="sticky top-0 z-40 w-full glass-panel border-b border-slate-200/50 px-6 py-4 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-xl md:text-2xl font-bold tracking-tight bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent m-0 leading-none">
              SocialSense-AI
            </h1>
            <p className="text-[10px] md:text-[11px] text-slate-500 mt-1 uppercase tracking-wider font-semibold">
        ...
        <div className="hidden lg:flex items-center space-x-3">
          ...
          <div className="group flex items-center px-3 py-1.5 rounded-full bg-white/40 hover:bg-white/80 border border-slate-200/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-default backdrop-blur-md">
            <Search size={13} className="text-indigo-500 mr-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-[11px] font-semibold bg-gradient-to-r from-slate-700 to-slate-900 bg-clip-text text-transparent">Semantic Search</span>
          </div>

          <div className="group flex items-center px-3 py-1.5 rounded-full bg-white/40 hover:bg-white/80 border border-slate-200/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-default backdrop-blur-md">
            <Brain size={13} className="text-purple-500 mr-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-[11px] font-semibold bg-gradient-to-r from-slate-700 to-slate-900 bg-clip-text text-transparent">Sentence Transformers</span>
          </div>

          <div className="group flex items-center px-3 py-1.5 rounded-full bg-gradient-to-r from-indigo-50/80 to-purple-50/80 hover:from-indigo-100 hover:to-purple-100 border border-indigo-200/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-default backdrop-blur-md">
            <Zap size={13} className="text-amber-500 mr-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-[11px] font-bold bg-gradient-to-r from-indigo-700 to-purple-700 bg-clip-text text-transparent">AI Powered</span>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 mb-4 font-display">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm space-y-4">
              ...
              <form onSubmit={handleSearch} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-14 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-slate-900 placeholder-slate-400"
                  />
                  {searchQuery && (
                    <button
                      type="button"
              ...
              {isSearching && (
                <button
                  onClick={handleClear}
                  className="w-full py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 font-medium rounded-xl text-xs transition-all"
                >
                  ← Back to All Posts
                </button>
              )}
              ...
              <div className="flex flex-col gap-2 pt-1">
                {SUGGESTIONS.map((item, index) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 bg-slate-50 hover:bg-indigo-500 hover:text-white border border-slate-200 rounded-xl text-xs transition-all flex items-center justify-between group"
                  >
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {/* Filter bar */}
            <div className="bg-white p-4 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">

              {/* Result count / active query indicator */}
              <div className="text-xs text-slate-500 flex items-center gap-1.5 flex-wrap">
                <Layers size={14} className="text-indigo-500 shrink-0" />
                <span>Showing</span>
                <span className="font-semibold text-slate-900">{filteredPosts.length} posts</span>
                {activeQuery && (
                  <>
                    <span>matching</span>
                    <span className="px-2 py-0.5 rounded bg-indigo-50 text-indigo-600 font-medium max-w-[180px] truncate">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-slate-50 border border-slate-200 rounded-lg px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500 text-slate-800"
                  >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-slate-50 border border-slate-200 rounded-lg px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500 max-w-[130px] text-slate-800"
                  >
            ...
            {/* Error banner */}
            {error && (
              <div className="p-4 bg-red-50 border border-red-200 rounded-2xl flex items-center gap-3 text-red-600 text-xs">
            ...
            {isLoading ? (
              ...
              /* Empty state */
              <div className="flex flex-col items-center justify-center text-center py-24 bg-white border border-dashed border-slate-200 rounded-3xl px-8 gap-4">
                <div className="w-12 h-12 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-500">
                  <Search size={24} />
                </div>
                <div className="space-y-1">
                  <h3 className="text-base font-bold text-slate-900">No matching posts found</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {filteredPosts.map((post) => {
                  ...
                  return (
                    <article
                      key={post.id}
                      className="bg-white border border-slate-200/50 hover:border-indigo-500/50 rounded-2xl p-5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between group"
                    >
      ...
      {/* ─── Footer ─── */}
      <footer className="mt-20 py-8 border-t border-slate-200/50 glass-panel text-center text-xs text-slate-400">
        <p className="font-semibold text-slate-500">SocialSense-AI</p>
